	...
	<div id="contents">
			...
			<div class="detail_submenu4">
				<div class="detail_submenuBox">
					...
					<div class="detail_submenuList">
						...
						<ul style="list-style: none; padding: 0px; width: 150px; height: 1px; background-color: #f1f1f1;"></ul>
						<ul style="list-style: none; padding: 0px;">
							<li><a onclick="location='mrdetail.no'" style="color: #ff95a1;">머랭쿠키</a></li>
						</ul>
						<ul style="list-style: none; padding: 0px; width: 150px; height: 1px; background-color: #f1f1f1;"></ul>
						<ul style="list-style: none; padding: 0px;">
		...
		<div id="content1">
			<ul>
				<li>
					<div>
						<img alt="" src="img/mr배너1.PNG" class="chokodetail0">
					</div>
				</li>
			</ul>
		</div>
		<div id="content2">
			<ul>
				<li>
					<div>
						<img style="margin: 0 190px 0 0;" alt="" src="img/zmrset1.png"
							class="chokodetail">
					</div>
				</li>
			</ul>
			<ul>
				<li>
					<div>
						<img alt="" src="img/zmrset2.png" class="chokodetail">
					</div>
				</li>
			</ul>
			<ul>
				<li>
					<div>
						<img alt="" src="img/zmrset3.png" class="chokodetail">
					</div>
				</li>
			</ul>
			<ul>
				<li>
					<div>
						<img alt="" src="img/zmrset4.png" class="chokodetail">
					</div>
				</li>
			</ul>
			<ul>
				<li>
					<div>
						<img alt="" src="img/zmrset5.png" class="chokodetail">
					</div>
				</li>
			</ul>
			<ul>
				<li>
					<div>
						<img alt="" src="img/zmrset6.png" class="chokodetail">
					</div>
				</li>
			</ul>
			<ul>
				<li>
					<div>
						<img alt="" src="img/zmrset7.png" class="chokodetail">
					</div>
				</li>
			</ul>
